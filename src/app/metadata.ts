...
export const metadata: Metadata = {
  ...
  description: "OpticsKit 是为中国光学研究者打造的免费在线光学工具箱，提供色度图在线计算、光谱分析工具、光学模拟、衍射干涉模拟、薄膜干涉、材料折射率查询、激光参数速查、柯西色散拟合、相机镜头选型等9个光学在线工具，基于CIE/ISO国际标准",
